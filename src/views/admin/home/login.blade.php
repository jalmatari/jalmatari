...
<head>
    ...
    <link href="{{url('/')}}/jalmatari/dist/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    ...
    <![endif]--><link href="{{url('/')}}/jalmatari/dist/css/rtl.css" rel="stylesheet" type="text/css"/>
